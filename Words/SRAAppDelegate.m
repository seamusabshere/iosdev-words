...
//  Words
//
//  Created by Seamus Abshere on 5/17/13.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  [SRAWord bootstrap:wordsURL];
  
  SRALettersTableViewController *lettersTableViewController = [[SRALettersTableViewController alloc] init];
  self.navigationController = [[UINavigationController alloc] initWithRootViewController:lettersTableViewController];
